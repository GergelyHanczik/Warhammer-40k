...
/**
 * <h1>Valkyrie (Void Capable) Airborne Assault Carrier</h1>
 */
public class VoidCapableValkyrie extends Aircraft {
    public VoidCapableValkyrie() {
        super();
        this.vehicleName = "Void-Capable Valkyrie";
